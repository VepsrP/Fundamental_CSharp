...
public class Microworld : IStageSettings
{
    ...
    public Func<PlayerState, int> MinBuilding => ps => ps.Vacuum.True ? 1 : 3;
    public Func<PlayerState, int> MaxBuilding => _ => 5;
    public Func<PlayerState, int> MinUpgrade => _ => 1;
    public Func<PlayerState, int> MaxUpgrade => ps => !ps.Upgrades[1][6].Bought ? 6 : ps.Vacuum.True ? 11 : 10;
    public Func<PlayerState, int> MinResearch => _ => 1;
    public Func<PlayerState, int> MaxResearch => _ => 6;
    public Func<PlayerState, int> MinResearchExtra => ps => ps.Vacuum.True ? 1 : 0;
    public Func<PlayerState, int> MaxResearchExtra => ps => ps.Vacuum.True ? 6 : 0;
